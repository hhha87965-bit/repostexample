...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="/">Главная</a></li>
            <li class="menu-item hidden"><a href="/excelupload">Загрузить файл</a></li>
            <li class="menu-item hidden"><a href="/excelupload/files">Список файлов</a></li>
            <li class="menu-item hidden"><a href="/excelupload/logs">Журнал действий</a></li>
        </ul>
    </div>
    ...
    <div class="heroe">
        ...
        <h2>Система управления Excel файлами с полным функционалом</h2>
...
<section>
    ...
    <p>Добро пожаловать в систему управления Excel файлами! Эта система позволяет:</p>

    <ul>
        <li>Загружать Excel файлы (.xlsx, .xls) с проверкой формата</li>
        <li>Просматривать содержимое файлов в удобном табличном виде</li>
        <li>Редактировать данные прямо в браузере</li>
        <li>Добавлять и удалять строки</li>
        <li>Экспортировать данные в Excel и PDF</li>
        <li>Вести журнал всех действий</li>
    </ul>

    <div style="text-align: center; margin: 2rem 0;">
        <a href="/excelupload" style="display: inline-block; background-color: #dd4814; color: white; padding: 15px 30px; text-decoration: none; border-radius: 5px; font-size: 1.2rem; margin: 0 10px;">
            Загрузить файл
        </a>
        <a href="/excelupload/files" style="display: inline-block; background-color: #28a745; color: white; padding: 15px 30px; text-decoration: none; border-radius: 5px; font-size: 1.2rem; margin: 0 10px;">
            Список файлов
        </a>
    </div>
...
<div class="further">
    ...
    <section>
        ...
        <p>Поддержка форматов .xlsx и .xls с валидацией размера (до 10MB). 
           Drag & Drop интерфейс для удобной загрузки файлов.</p>
        ...
        <p>Полнофункциональное редактирование данных с AJAX. Добавление, редактирование 
           и удаление строк через модальные окна. Автосохранение изменений.</p>
        ...
        <p>Экспорт данных в Excel (.xlsx) и PDF форматы. Генерация отчетов 
           с настраиваемыми параметрами и автоматическим форматированием.</p>
